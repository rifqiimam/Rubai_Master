...
@Component
class RegionMasterSpecification {
    private val log: Logger = LoggerFactory.getLogger(this.javaClass)

    fun buildSpecification(params: Map<String, String?>): Specification<RegionMaster> {
            ...
            params.forEach { (key, value) ->
                if (!value.isNullOrBlank()) {
                    when (key) {
                        ...
                        // Partial text search for regionName (case-insensitive)
                        "regionName" -> {
                            predicates.add(
